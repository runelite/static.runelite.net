...
cachedir=oldschool
storebase=0
initial_jar=gamepack_1978391.jar
...
param=9=p1cxIGuofoK-oTjcVb*eIc4XazeQXzFbbaRq*iENNrfirkncGldMjg
param=7=0
param=3=true
param=4=1
...
param=8=true
param=10=5
runelite.gamepack=https://repo.runelite.net/net/runelite/rs/vanilla/222/vanilla-222.jar
